...
if __name__ == "__main__":
    args = parse_args()
    print(f"Training up/down CNN with tag: {args.tag}")
    print(f"Training up/down CNN with bags: {args.bags}")
    print(f"Training up/down CNN with features: {args.features}")
    if args.arm_joints is not None:
        print(
            f"Training up/down CNN with arm_joints={args.arm_joints} "
